...
constexpr Field<Access::RW, uint32_t, false> nvic_iser0_setena{0xE000E100u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> nvic_iser1_setena{0xE000E104u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> nvic_iser2_setena{0xE000E108u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> nvic_icer0_clrena{0xE000E180u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> nvic_icer1_clrena{0xE000E184u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> nvic_icer2_clrena{0xE000E188u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> nvic_ispr0_setpend{0xE000E200u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> nvic_ispr1_setpend{0xE000E204u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> nvic_ispr2_setpend{0xE000E208u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> nvic_icpr0_clrpend{0xE000E280u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> nvic_icpr1_clrpend{0xE000E284u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> nvic_icpr2_clrpend{0xE000E288u, 0xFFFFFFFFu, 0};
