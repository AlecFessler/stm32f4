...
constexpr Field<Access::RW, dac::Dmaudrie, true> dac_cr_dmaudrie2{0x40007400u, 0x20000000u, 29};
constexpr Field<Access::RW, dac::Dmaudrie, true> dac_cr_dmaudrie1{0x40007400u, 0x00002000u, 13};
constexpr Field<Access::RW, dac::Dmaen, true> dac_cr_dmaen2{0x40007400u, 0x10000000u, 28};
constexpr Field<Access::RW, dac::Dmaen, true> dac_cr_dmaen1{0x40007400u, 0x00001000u, 12};
...
constexpr Field<Access::RW, dac::Ten, true> dac_cr_ten2{0x40007400u, 0x00040000u, 18};
constexpr Field<Access::RW, dac::Ten, true> dac_cr_ten1{0x40007400u, 0x00000004u, 2};
constexpr Field<Access::RW, dac::Boff, true> dac_cr_boff2{0x40007400u, 0x00020000u, 17};
constexpr Field<Access::RW, dac::Boff, true> dac_cr_boff1{0x40007400u, 0x00000002u, 1};
constexpr Field<Access::RW, dac::En, true> dac_cr_en2{0x40007400u, 0x00010000u, 16};
constexpr Field<Access::RW, dac::En, true> dac_cr_en1{0x40007400u, 0x00000001u, 0};
...
constexpr Field<Access::RW, uint32_t, false, false> dac_dhr12r1_dacc1dhr{0x40007408u, 0x00000FFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> dac_dhr12l1_dacc1dhr{0x4000740Cu, 0x0000FFF0u, 4};
constexpr Field<Access::RW, uint32_t, false, false> dac_dhr8r1_dacc1dhr{0x40007410u, 0x000000FFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> dac_dhr12r2_dacc2dhr{0x40007414u, 0x00000FFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> dac_dhr12l2_dacc2dhr{0x40007418u, 0x0000FFF0u, 4};
constexpr Field<Access::RW, uint32_t, false, false> dac_dhr8r2_dacc2dhr{0x4000741Cu, 0x000000FFu, 0};
...
constexpr Field<Access::RC_W1, dac::Dmaudr, false, false> dac_sr_dmaudr2{0x40007434u, 0x20000000u, 29, 0x20002000u, 0x00000000u};
constexpr Field<Access::RC_W1, dac::Dmaudr, false, false> dac_sr_dmaudr1{0x40007434u, 0x00002000u, 13, 0x20002000u, 0x00000000u};
