...
constexpr Field<Access::RW, tim7::Arpe, true, true> tim7_cr1_arpe{0x40001400u, 0x00000080u, 7};
constexpr Field<Access::RW, tim7::Opm, true, true> tim7_cr1_opm{0x40001400u, 0x00000008u, 3};
constexpr Field<Access::RW, tim7::Urs, true, true> tim7_cr1_urs{0x40001400u, 0x00000004u, 2};
constexpr Field<Access::RW, tim7::Udis, true, true> tim7_cr1_udis{0x40001400u, 0x00000002u, 1};
constexpr Field<Access::RW, tim7::Cen, true, true> tim7_cr1_cen{0x40001400u, 0x00000001u, 0};
constexpr Field<Access::RW, tim7::Mms, false> tim7_cr2_mms{0x40001404u, 0x00000070u, 4};
constexpr Field<Access::RW, tim7::Ude, true, true> tim7_dier_ude{0x4000140Cu, 0x00000100u, 8};
constexpr Field<Access::RW, tim7::Uie, true, true> tim7_dier_uie{0x4000140Cu, 0x00000001u, 0};
