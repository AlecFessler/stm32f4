...
constexpr Field<Access::RW, tim4::Ccof> tim4_sr_cc4of{0x40000810u, 0x00001000u, 12};
constexpr Field<Access::RW, tim4::Ccof> tim4_sr_cc3of{0x40000810u, 0x00000800u, 11};
constexpr Field<Access::RW, tim4::Ccof> tim4_sr_cc2of{0x40000810u, 0x00000400u, 10};
constexpr Field<Access::RW, tim4::Ccof> tim4_sr_cc1of{0x40000810u, 0x00000200u, 9};
constexpr Field<Access::RW, tim4::Tif> tim4_sr_tif{0x40000810u, 0x00000040u, 6};
constexpr Field<Access::RW, tim4::Ccif> tim4_sr_cc4if{0x40000810u, 0x00000010u, 4};
constexpr Field<Access::RW, tim4::Ccif> tim4_sr_cc3if{0x40000810u, 0x00000008u, 3};
constexpr Field<Access::RW, tim4::Ccif> tim4_sr_cc2if{0x40000810u, 0x00000004u, 2};
constexpr Field<Access::RW, tim4::Ccif> tim4_sr_cc1if{0x40000810u, 0x00000002u, 1};
constexpr Field<Access::RW, tim4::Uif> tim4_sr_uif{0x40000810u, 0x00000001u, 0};
