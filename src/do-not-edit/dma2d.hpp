...
constexpr Field<Access::RW, uint32_t, true, true> dma2d_cr_ceie{0x4002B000u, 0x00002000u, 13, 0x00000005u, 0x00000000u};
constexpr Field<Access::RW, uint32_t, true, true> dma2d_cr_ctcie{0x4002B000u, 0x00001000u, 12, 0x00000005u, 0x00000000u};
constexpr Field<Access::RW, uint32_t, true, true> dma2d_cr_caeie{0x4002B000u, 0x00000800u, 11, 0x00000005u, 0x00000000u};
constexpr Field<Access::RW, uint32_t, true, true> dma2d_cr_twie{0x4002B000u, 0x00000400u, 10, 0x00000005u, 0x00000000u};
constexpr Field<Access::RW, uint32_t, true, true> dma2d_cr_tcie{0x4002B000u, 0x00000200u, 9, 0x00000005u, 0x00000000u};
constexpr Field<Access::RW, uint32_t, true, true> dma2d_cr_teie{0x4002B000u, 0x00000100u, 8, 0x00000005u, 0x00000000u};
constexpr Field<Access::RS, uint32_t, true, true> dma2d_cr_abort{0x4002B000u, 0x00000004u, 2, 0x00000005u, 0x00000000u};
constexpr Field<Access::RW, uint32_t, true, true> dma2d_cr_susp{0x4002B000u, 0x00000002u, 1, 0x00000005u, 0x00000000u};
constexpr Field<Access::RS, uint32_t, true, true> dma2d_cr_start{0x4002B000u, 0x00000001u, 0, 0x00000005u, 0x00000000u};
...
constexpr Field<Access::RC_W1, uint32_t, false> dma2d_ifcr_cceif{0x4002B008u, 0x00000020u, 5, 0x0000003Fu, 0x00000000u};
constexpr Field<Access::RC_W1, uint32_t, false> dma2d_ifcr_cctcif{0x4002B008u, 0x00000010u, 4, 0x0000003Fu, 0x00000000u};
constexpr Field<Access::RC_W1, uint32_t, false> dma2d_ifcr_caecif{0x4002B008u, 0x00000008u, 3, 0x0000003Fu, 0x00000000u};
constexpr Field<Access::RC_W1, uint32_t, false> dma2d_ifcr_ctwif{0x4002B008u, 0x00000004u, 2, 0x0000003Fu, 0x00000000u};
constexpr Field<Access::RC_W1, uint32_t, false> dma2d_ifcr_ctcif{0x4002B008u, 0x00000002u, 1, 0x0000003Fu, 0x00000000u};
constexpr Field<Access::RC_W1, uint32_t, false> dma2d_ifcr_cteif{0x4002B008u, 0x00000001u, 0, 0x0000003Fu, 0x00000000u};
constexpr Field<Access::RW, uint32_t, false> dma2d_fgmar_ma{0x4002B00Cu, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> dma2d_fgor_lo{0x4002B010u, 0x00003FFFu, 0};
constexpr Field<Access::RW, uint32_t, false> dma2d_bgmar_ma{0x4002B014u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> dma2d_bgor_lo{0x4002B018u, 0x00003FFFu, 0};
...
constexpr Field<Access::RS, uint32_t, true, true> dma2d_fgpfccr_start{0x4002B01Cu, 0x00000020u, 5, 0x00000020u, 0x00000000u};
constexpr Field<Access::RW, uint32_t, true, true> dma2d_fgpfccr_ccm{0x4002B01Cu, 0x00000010u, 4, 0x00000020u, 0x00000000u};
...
constexpr Field<Access::RS, uint32_t, true, true> dma2d_bgpfccr_start{0x4002B024u, 0x00000020u, 5, 0x00000020u, 0x00000000u};
constexpr Field<Access::RW, uint32_t, true, true> dma2d_bgpfccr_ccm{0x4002B024u, 0x00000010u, 4, 0x00000020u, 0x00000000u};
...
constexpr Field<Access::RW, uint32_t, false> dma2d_fgcmar_ma{0x4002B02Cu, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> dma2d_bgcmar_ma{0x4002B030u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> dma2d_opfccr_cm{0x4002B034u, 0x00000007u, 0};
...
constexpr Field<Access::RW, uint32_t, false> dma2d_omar_ma{0x4002B03Cu, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> dma2d_oor_lo{0x4002B040u, 0x00003FFFu, 0};
...
constexpr Field<Access::RW, uint32_t, false> dma2d_lwr_lw{0x4002B048u, 0x0000FFFFu, 0};
constexpr Field<Access::RW> dma2d_amtcr_dt{0x4002B04Cu, 0x0000FF00u, 8};
constexpr Field<Access::RW, uint32_t, true, true> dma2d_amtcr_en{0x4002B04Cu, 0x00000001u, 0};
