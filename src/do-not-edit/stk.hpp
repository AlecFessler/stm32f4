...
constexpr Field<Access::RW, uint32_t, false, false> stk_load_reload{0xE000E014u, 0x00FFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> stk_val_current{0xE000E018u, 0x00FFFFFFu, 0};
