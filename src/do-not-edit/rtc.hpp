...
constexpr Field<Access::RW, rtc::Shpf, 0x00000000u, 0x00007F20u, true> rtc_isr_shpf{0x4000280Cu, 0x00000008u, 3};
constexpr Field<Access::RO, rtc::Inits> rtc_isr_inits{0x4000280Cu, 0x00000010u, 4};
constexpr Field<Access::RC_W0, rtc::Rsf, 0x00000000u, 0x00007F20u, true> rtc_isr_rsf{0x4000280Cu, 0x00000020u, 5};
constexpr Field<Access::RO, rtc::Initf> rtc_isr_initf{0x4000280Cu, 0x00000040u, 6};
constexpr Field<Access::RW, rtc::Init, 0x00000000u, 0x00007F20u, true> rtc_isr_init{0x4000280Cu, 0x00000080u, 7};
constexpr Field<Access::RC_W0, rtc::Alrabf, 0x00000000u, 0x00007F20u, true> rtc_isr_alraf{0x4000280Cu, 0x00000100u, 8};
constexpr Field<Access::RC_W0, rtc::Alrabf, 0x00000000u, 0x00007F20u, true> rtc_isr_alrbf{0x4000280Cu, 0x00000200u, 9};
constexpr Field<Access::RC_W0, rtc::Wutf, 0x00000000u, 0x00007F20u, true> rtc_isr_wutf{0x4000280Cu, 0x00000400u, 10};
constexpr Field<Access::RC_W0, rtc::Tsf, 0x00000000u, 0x00007F20u, true> rtc_isr_tsf{0x4000280Cu, 0x00000800u, 11};
constexpr Field<Access::RC_W0, rtc::Tsovf, 0x00000000u, 0x00007F20u, true> rtc_isr_tsovf{0x4000280Cu, 0x00001000u, 12};
constexpr Field<Access::RC_W0, rtc::Tampf, 0x00000000u, 0x00007F20u, true> rtc_isr_tamp1f{0x4000280Cu, 0x00002000u, 13};
constexpr Field<Access::RC_W0, rtc::Tampf, 0x00000000u, 0x00007F20u, true> rtc_isr_tamp2f{0x4000280Cu, 0x00004000u, 14};
