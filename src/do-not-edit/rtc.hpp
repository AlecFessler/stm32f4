...
constexpr Field<Access::RW, rtc::Pm, true, true> rtc_tr_pm{0x40002800u, 0x00400000u, 22};
...
constexpr Field<Access::RW, rtc::Mt, true, true> rtc_dr_mt{0x40002804u, 0x00001000u, 12};
...
constexpr Field<Access::RW, rtc::Coe, true, true> rtc_cr_coe{0x40002808u, 0x00800000u, 23};
constexpr Field<Access::RW, rtc::Osel> rtc_cr_osel{0x40002808u, 0x00600000u, 21};
constexpr Field<Access::RW, rtc::Pol, true, true> rtc_cr_pol{0x40002808u, 0x00100000u, 20};
constexpr Field<Access::RW, rtc::Bkp, true, true> rtc_cr_bkp{0x40002808u, 0x00040000u, 18};
constexpr Field<Access::RW, rtc::Sub1h, true, true> rtc_cr_sub1h{0x40002808u, 0x00020000u, 17};
constexpr Field<Access::RW, rtc::Add1h, true, true> rtc_cr_add1h{0x40002808u, 0x00010000u, 16};
constexpr Field<Access::RW, rtc::Tsie, true, true> rtc_cr_tsie{0x40002808u, 0x00008000u, 15};
constexpr Field<Access::RW, rtc::Wutie, true, true> rtc_cr_wutie{0x40002808u, 0x00004000u, 14};
constexpr Field<Access::RW, rtc::Alrabie, true, true> rtc_cr_alrbie{0x40002808u, 0x00002000u, 13};
constexpr Field<Access::RW, rtc::Alrabie, true, true> rtc_cr_alraie{0x40002808u, 0x00001000u, 12};
constexpr Field<Access::RW, rtc::Tse, true, true> rtc_cr_tse{0x40002808u, 0x00000800u, 11};
constexpr Field<Access::RW, rtc::Wute, true, true> rtc_cr_wute{0x40002808u, 0x00000400u, 10};
constexpr Field<Access::RW, rtc::Alrabe, true, true> rtc_cr_alrbe{0x40002808u, 0x00000200u, 9};
constexpr Field<Access::RW, rtc::Alrabe, true, true> rtc_cr_alrae{0x40002808u, 0x00000100u, 8};
constexpr Field<Access::RW, uint32_t, true, true> rtc_cr_dce{0x40002808u, 0x00000080u, 7};
constexpr Field<Access::RW, rtc::Fmt, true, true> rtc_cr_fmt{0x40002808u, 0x00000040u, 6};
constexpr Field<Access::RW, rtc::Refckon, true, true> rtc_cr_refckon{0x40002808u, 0x00000010u, 4};
constexpr Field<Access::RW, rtc::Tsedge, true, true> rtc_cr_tsedge{0x40002808u, 0x00000008u, 3};
...
constexpr Field<Access::RO, rtc::Shpf> rtc_isr_shpf{0x4000280Cu, 0x00000008u, 3, 0x00000000u, 0x00007F20u};
constexpr Field<Access::RO, rtc::Inits> rtc_isr_inits{0x4000280Cu, 0x00000010u, 4};
constexpr Field<Access::RC_W0, rtc::Rsf, true, true> rtc_isr_rsf{0x4000280Cu, 0x00000020u, 5, 0x00000000u, 0x00007F20u};
constexpr Field<Access::RO, rtc::Initf> rtc_isr_initf{0x4000280Cu, 0x00000040u, 6};
constexpr Field<Access::RW, rtc::Init, false> rtc_isr_init{0x4000280Cu, 0x00000080u, 7, 0x00000000u, 0x00007F20u};
constexpr Field<Access::RC_W0, rtc::Alrabf, true, true> rtc_isr_alraf{0x4000280Cu, 0x00000100u, 8, 0x00000000u, 0x00007F20u};
constexpr Field<Access::RC_W0, rtc::Alrabf, true, true> rtc_isr_alrbf{0x4000280Cu, 0x00000200u, 9, 0x00000000u, 0x00007F20u};
constexpr Field<Access::RC_W0, rtc::Wutf, true, true> rtc_isr_wutf{0x4000280Cu, 0x00000400u, 10, 0x00000000u, 0x00007F20u};
constexpr Field<Access::RC_W0, rtc::Tsf, true, true> rtc_isr_tsf{0x4000280Cu, 0x00000800u, 11, 0x00000000u, 0x00007F20u};
constexpr Field<Access::RC_W0, rtc::Tsovf, true, true> rtc_isr_tsovf{0x4000280Cu, 0x00001000u, 12, 0x00000000u, 0x00007F20u};
constexpr Field<Access::RC_W0, rtc::Tampf, true, true> rtc_isr_tamp1f{0x4000280Cu, 0x00002000u, 13, 0x00000000u, 0x00007F20u};
constexpr Field<Access::RC_W0, rtc::Tampf, true, true> rtc_isr_tamp2f{0x4000280Cu, 0x00004000u, 14, 0x00000000u, 0x00007F20u};
...
constexpr Field<Access::RW, uint32_t, false> rtc_wutr_wut{0x40002814u, 0x0000FFFFu, 0};
constexpr Field<Access::RW, uint32_t, true, true> rtc_calibr_dcs{0x40002818u, 0x00000080u, 7};
constexpr Field<Access::RW> rtc_calibr_dc{0x40002818u, 0x0000001Fu, 0};
constexpr Field<Access::RW, rtc::Wdsel, true, true> rtc_alrmar_wdsel{0x4000281Cu, 0x40000000u, 30};
...
constexpr Field<Access::RW, rtc::Pm, true, true> rtc_alrmar_pm{0x4000281Cu, 0x00400000u, 22};
...
constexpr Field<Access::RW, rtc::Msk, true, true> rtc_alrmar_msk4{0x4000281Cu, 0x80000000u, 31};
constexpr Field<Access::RW, rtc::Msk, true, true> rtc_alrmar_msk3{0x4000281Cu, 0x00800000u, 23};
constexpr Field<Access::RW, rtc::Msk, true, true> rtc_alrmar_msk2{0x4000281Cu, 0x00008000u, 15};
constexpr Field<Access::RW, rtc::Msk, true, true> rtc_alrmar_msk1{0x4000281Cu, 0x00000080u, 7};
constexpr Field<Access::RW, rtc::Wdsel, true, true> rtc_alrmbr_wdsel{0x40002820u, 0x40000000u, 30};
...
constexpr Field<Access::RW, rtc::Pm, true, true> rtc_alrmbr_pm{0x40002820u, 0x00400000u, 22};
...
constexpr Field<Access::RW, rtc::Msk, true, true> rtc_alrmbr_msk4{0x40002820u, 0x80000000u, 31};
constexpr Field<Access::RW, rtc::Msk, true, true> rtc_alrmbr_msk3{0x40002820u, 0x00800000u, 23};
constexpr Field<Access::RW, rtc::Msk, true, true> rtc_alrmbr_msk2{0x40002820u, 0x00008000u, 15};
constexpr Field<Access::RW, rtc::Msk, true, true> rtc_alrmbr_msk1{0x40002820u, 0x00000080u, 7};
...
constexpr Field<Access::RW, rtc::Calp, true, true> rtc_calr_calp{0x4000283Cu, 0x00008000u, 15};
constexpr Field<Access::RW> rtc_calr_calm{0x4000283Cu, 0x000001FFu, 0};
constexpr Field<Access::RW, rtc::Calw8, true, true> rtc_calr_calw8{0x4000283Cu, 0x00004000u, 14};
constexpr Field<Access::RW, rtc::Calw16, true, true> rtc_calr_calw16{0x4000283Cu, 0x00002000u, 13};
constexpr Field<Access::RW, uint32_t, true, true> rtc_tafcr_alarmouttype{0x40002840u, 0x00040000u, 18};
constexpr Field<Access::RW, uint32_t, true, true> rtc_tafcr_tsinsel{0x40002840u, 0x00020000u, 17};
constexpr Field<Access::RW, uint32_t, true, true> rtc_tafcr_tamp1insel{0x40002840u, 0x00010000u, 16};
constexpr Field<Access::RW, uint32_t, true, true> rtc_tafcr_tamppudis{0x40002840u, 0x00008000u, 15};
...
constexpr Field<Access::RW, uint32_t, true, true> rtc_tafcr_tampts{0x40002840u, 0x00000080u, 7};
constexpr Field<Access::RW, uint32_t, true, true> rtc_tafcr_tamp2trg{0x40002840u, 0x00000010u, 4};
constexpr Field<Access::RW, uint32_t, true, true> rtc_tafcr_tamp2e{0x40002840u, 0x00000008u, 3};
constexpr Field<Access::RW, uint32_t, true, true> rtc_tafcr_tampie{0x40002840u, 0x00000004u, 2};
constexpr Field<Access::RW, uint32_t, true, true> rtc_tafcr_tamp1trg{0x40002840u, 0x00000002u, 1};
constexpr Field<Access::RW, uint32_t, true, true> rtc_tafcr_tamp1e{0x40002840u, 0x00000001u, 0};
...
constexpr Field<Access::RW, uint32_t, false> rtc_bkp0r_bkp{0x40002850u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp1r_bkp{0x40002854u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp2r_bkp{0x40002858u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp3r_bkp{0x4000285Cu, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp4r_bkp{0x40002860u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp5r_bkp{0x40002864u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp6r_bkp{0x40002868u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp7r_bkp{0x4000286Cu, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp8r_bkp{0x40002870u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp9r_bkp{0x40002874u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp10r_bkp{0x40002878u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp11r_bkp{0x4000287Cu, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp12r_bkp{0x40002880u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp13r_bkp{0x40002884u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp14r_bkp{0x40002888u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp15r_bkp{0x4000288Cu, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp16r_bkp{0x40002890u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp17r_bkp{0x40002894u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp18r_bkp{0x40002898u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> rtc_bkp19r_bkp{0x4000289Cu, 0xFFFFFFFFu, 0};
