...
constexpr Field<Access::RW, sai::Nodiv> sai_acr1_nodiv{0x40015804u, 0x00080000u, 19};
constexpr Field<Access::RW, sai::Dmaen> sai_acr1_dmaen{0x40015804u, 0x00020000u, 17};
constexpr Field<Access::RW, sai::Saien> sai_acr1_saiaen{0x40015804u, 0x00010000u, 16};
constexpr Field<Access::RW> sai_acr1_outdri{0x40015804u, 0x00002000u, 13};
constexpr Field<Access::RW, sai::Mono> sai_acr1_mono{0x40015804u, 0x00001000u, 12};
constexpr Field<Access::RW, sai::Syncen> sai_acr1_syncen{0x40015804u, 0x00000C00u, 10};
constexpr Field<Access::RW, sai::Ckstr> sai_acr1_ckstr{0x40015804u, 0x00000200u, 9};
constexpr Field<Access::RW, sai::Lsbfirst> sai_acr1_lsbfirst{0x40015804u, 0x00000100u, 8};
...
constexpr Field<Access::RW, sai::Cpl> sai_acr2_cpl{0x40015808u, 0x00002000u, 13};
constexpr Field<Access::RW> sai_acr2_mutecn{0x40015808u, 0x00001F80u, 7};
constexpr Field<Access::RW, sai::Muteval> sai_acr2_muteval{0x40015808u, 0x00000040u, 6};
constexpr Field<Access::RW, sai::Mute> sai_acr2_mute{0x40015808u, 0x00000020u, 5};
...
constexpr Field<Access::RW, sai::Fsoff> sai_afrcr_fsoff{0x4001580Cu, 0x00040000u, 18};
constexpr Field<Access::RW, sai::Fspol> sai_afrcr_fspol{0x4001580Cu, 0x00020000u, 17};
...
constexpr Field<Access::RW, sai::Afsdetie> sai_aim_afsdetie{0x40015814u, 0x00000020u, 5};
constexpr Field<Access::RW, sai::Cnrdyie> sai_aim_cnrdyie{0x40015814u, 0x00000010u, 4};
constexpr Field<Access::RW, sai::Freqie> sai_aim_freqie{0x40015814u, 0x00000008u, 3};
...
constexpr Field<Access::RW, sai::Ovrudrie> sai_aim_ovrudrie{0x40015814u, 0x00000001u, 0};
constexpr Field<Access::RW, sai::Flth> sai_asr_flvl{0x40015818u, 0x00070000u, 16};
constexpr Field<Access::RW, sai::Lfsdet> sai_asr_lfsdet{0x40015818u, 0x00000040u, 6};
constexpr Field<Access::RW, sai::Afsdet> sai_asr_afsdet{0x40015818u, 0x00000020u, 5};
constexpr Field<Access::RW, sai::Cnrdy> sai_asr_cnrdy{0x40015818u, 0x00000010u, 4};
constexpr Field<Access::RW, sai::Freq> sai_asr_freq{0x40015818u, 0x00000008u, 3};
constexpr Field<Access::RW, sai::Wckcfg> sai_asr_wckcfg{0x40015818u, 0x00000004u, 2};
constexpr Field<Access::RW, sai::Mutedet> sai_asr_mutedet{0x40015818u, 0x00000002u, 1};
constexpr Field<Access::RW, sai::Ovrudr> sai_asr_ovrudr{0x40015818u, 0x00000001u, 0};
constexpr Field<Access::RW> sai_aclrfr_lfsdet{0x4001581Cu, 0x00000040u, 6};
constexpr Field<Access::RW, sai::Cafsdet> sai_aclrfr_cafsdet{0x4001581Cu, 0x00000020u, 5};
...
constexpr Field<Access::RW, sai::Saien> sai_bcr1_saiben{0x40015824u, 0x00010000u, 16};
constexpr Field<Access::RW> sai_bcr1_outdri{0x40015824u, 0x00002000u, 13};
constexpr Field<Access::RW, sai::Mono> sai_bcr1_mono{0x40015824u, 0x00001000u, 12};
constexpr Field<Access::RW, sai::Syncen> sai_bcr1_syncen{0x40015824u, 0x00000C00u, 10};
constexpr Field<Access::RW, sai::Ckstr> sai_bcr1_ckstr{0x40015824u, 0x00000200u, 9};
constexpr Field<Access::RW, sai::Lsbfirst> sai_bcr1_lsbfirst{0x40015824u, 0x00000100u, 8};
...
constexpr Field<Access::RW, sai::Cpl> sai_bcr2_cpl{0x40015828u, 0x00002000u, 13};
constexpr Field<Access::RW> sai_bcr2_mutecn{0x40015828u, 0x00001F80u, 7};
constexpr Field<Access::RW, sai::Muteval> sai_bcr2_muteval{0x40015828u, 0x00000040u, 6};
constexpr Field<Access::RW, sai::Mute> sai_bcr2_mute{0x40015828u, 0x00000020u, 5};
...
constexpr Field<Access::RW, sai::Fsoff> sai_bfrcr_fsoff{0x4001582Cu, 0x00040000u, 18};
constexpr Field<Access::RW, sai::Fspol> sai_bfrcr_fspol{0x4001582Cu, 0x00020000u, 17};
...
constexpr Field<Access::RW, sai::Lfsdetie> sai_bim_lfsdetie{0x40015834u, 0x00000040u, 6};
constexpr Field<Access::RW, sai::Afsdetie> sai_bim_afsdetie{0x40015834u, 0x00000020u, 5};
constexpr Field<Access::RW, sai::Cnrdyie> sai_bim_cnrdyie{0x40015834u, 0x00000010u, 4};
constexpr Field<Access::RW, sai::Freqie> sai_bim_freqie{0x40015834u, 0x00000008u, 3};
...
constexpr Field<Access::RW, sai::Ovrudrie> sai_bim_ovrudrie{0x40015834u, 0x00000001u, 0};
