...
constexpr Field<Access::RW, uart4::Ue> uart4_cr1_ue{0x40004C0Cu, 0x00002000u, 13};
constexpr Field<Access::RW, uart4::M> uart4_cr1_m{0x40004C0Cu, 0x00001000u, 12};
constexpr Field<Access::RW, uart4::Wake> uart4_cr1_wake{0x40004C0Cu, 0x00000800u, 11};
constexpr Field<Access::RW, uart4::Pce> uart4_cr1_pce{0x40004C0Cu, 0x00000400u, 10};
constexpr Field<Access::RW, uart4::Ps> uart4_cr1_ps{0x40004C0Cu, 0x00000200u, 9};
constexpr Field<Access::RW, uart4::Peie> uart4_cr1_peie{0x40004C0Cu, 0x00000100u, 8};
constexpr Field<Access::RW, uart4::Txeie> uart4_cr1_txeie{0x40004C0Cu, 0x00000080u, 7};
constexpr Field<Access::RW, uart4::Tcie> uart4_cr1_tcie{0x40004C0Cu, 0x00000040u, 6};
constexpr Field<Access::RW, uart4::Rxneie> uart4_cr1_rxneie{0x40004C0Cu, 0x00000020u, 5};
constexpr Field<Access::RW, uart4::Idleie> uart4_cr1_idleie{0x40004C0Cu, 0x00000010u, 4};
constexpr Field<Access::RW, uart4::Te> uart4_cr1_te{0x40004C0Cu, 0x00000008u, 3};
constexpr Field<Access::RW, uart4::Re> uart4_cr1_re{0x40004C0Cu, 0x00000004u, 2};
constexpr Field<Access::RW, uart4::Rwu> uart4_cr1_rwu{0x40004C0Cu, 0x00000002u, 1};
constexpr Field<Access::RW, uart4::Sbk> uart4_cr1_sbk{0x40004C0Cu, 0x00000001u, 0};
constexpr Field<Access::RW, uart4::Over8> uart4_cr1_over8{0x40004C0Cu, 0x00008000u, 15};
constexpr Field<Access::RW, uart4::Linen> uart4_cr2_linen{0x40004C10u, 0x00004000u, 14};
constexpr Field<Access::RW, uart4::Stop> uart4_cr2_stop{0x40004C10u, 0x00003000u, 12};
constexpr Field<Access::RW, uart4::Lbdie> uart4_cr2_lbdie{0x40004C10u, 0x00000040u, 6};
constexpr Field<Access::RW, uart4::Lbdl> uart4_cr2_lbdl{0x40004C10u, 0x00000020u, 5};
constexpr Field<Access::RW> uart4_cr2_add{0x40004C10u, 0x0000000Fu, 0};
constexpr Field<Access::RW, uart4::Onebit> uart4_cr3_onebit{0x40004C14u, 0x00000800u, 11};
constexpr Field<Access::RW, uart4::Dmat> uart4_cr3_dmat{0x40004C14u, 0x00000080u, 7};
constexpr Field<Access::RW, uart4::Dmar> uart4_cr3_dmar{0x40004C14u, 0x00000040u, 6};
constexpr Field<Access::RW, uart4::Hdsel> uart4_cr3_hdsel{0x40004C14u, 0x00000008u, 3};
constexpr Field<Access::RW, uart4::Irlp> uart4_cr3_irlp{0x40004C14u, 0x00000004u, 2};
constexpr Field<Access::RW, uart4::Iren> uart4_cr3_iren{0x40004C14u, 0x00000002u, 1};
constexpr Field<Access::RW, uart4::Eie> uart4_cr3_eie{0x40004C14u, 0x00000001u, 0};
