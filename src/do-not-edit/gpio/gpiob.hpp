...
constexpr Field<Access::RW, gpio::Outputtype, true> gpiob_otyper_ot[16] = {
...
constexpr Field<Access::RO, gpio::Inputdata, true> gpiob_idr_idr[16] = {
...
constexpr Field<Access::RW, gpio::Outputdata, true> gpiob_odr_odr[16] = {
...
constexpr Field<Access::RW, gpio::Lock, true> gpiob_lckr_lck[16] = {
...
constexpr Field<Access::RW, gpio::Lockkey, true> gpiob_lckr_lckk{0x4002041Cu, 0x00010000u, 16};
