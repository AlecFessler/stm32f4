...
constexpr Field<Access::RW, gpio::Outputtype> gpiob_otyper_ot[16] = {
...
constexpr Field<Access::RW, gpio::Outputdata> gpiob_odr_odr[16] = {
...
constexpr Field<Access::RW, gpio::Lock> gpiob_lckr_lck[16] = {
...
constexpr Field<Access::RW, gpio::Lockkey> gpiob_lckr_lckk{0x4002041Cu, 0x00010000u, 16};
