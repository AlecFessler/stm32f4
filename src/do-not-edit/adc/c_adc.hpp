...
constexpr Field<Access::RO, c_adc::Ovr> c_adc_csr_ovr3{0x40012300u, 0x00200000u, 21};
constexpr Field<Access::RO, c_adc::Ovr> c_adc_csr_ovr2{0x40012300u, 0x00002000u, 13};
constexpr Field<Access::RO, c_adc::Ovr> c_adc_csr_ovr1{0x40012300u, 0x00000020u, 5};
constexpr Field<Access::RO, c_adc::Strt> c_adc_csr_strt3{0x40012300u, 0x00100000u, 20};
constexpr Field<Access::RO, c_adc::Strt> c_adc_csr_strt2{0x40012300u, 0x00001000u, 12};
constexpr Field<Access::RO, c_adc::Strt> c_adc_csr_strt1{0x40012300u, 0x00000010u, 4};
constexpr Field<Access::RO, c_adc::Jstrt> c_adc_csr_jstrt3{0x40012300u, 0x00080000u, 19};
constexpr Field<Access::RO, c_adc::Jstrt> c_adc_csr_jstrt2{0x40012300u, 0x00000800u, 11};
constexpr Field<Access::RO, c_adc::Jstrt> c_adc_csr_jstrt1{0x40012300u, 0x00000008u, 3};
constexpr Field<Access::RO, c_adc::Jeoc> c_adc_csr_jeoc3{0x40012300u, 0x00040000u, 18};
constexpr Field<Access::RO, c_adc::Jeoc> c_adc_csr_jeoc2{0x40012300u, 0x00000400u, 10};
constexpr Field<Access::RO, c_adc::Jeoc> c_adc_csr_jeoc1{0x40012300u, 0x00000004u, 2};
constexpr Field<Access::RO, c_adc::Eoc> c_adc_csr_eoc3{0x40012300u, 0x00020000u, 17};
constexpr Field<Access::RO, c_adc::Eoc> c_adc_csr_eoc2{0x40012300u, 0x00000200u, 9};
constexpr Field<Access::RO, c_adc::Eoc> c_adc_csr_eoc1{0x40012300u, 0x00000002u, 1};
