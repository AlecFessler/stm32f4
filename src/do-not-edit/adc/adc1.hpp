...
constexpr Field<Access::RC_W0, adc1::Ovr, false, false> adc1_sr_ovr{0x40012000u, 0x00000020u, 5, 0x00000000u, 0x0000003Fu};
constexpr Field<Access::RC_W0, adc1::Strt, false, false> adc1_sr_strt{0x40012000u, 0x00000010u, 4, 0x00000000u, 0x0000003Fu};
constexpr Field<Access::RC_W0, adc1::Jstrt, false, false> adc1_sr_jstrt{0x40012000u, 0x00000008u, 3, 0x00000000u, 0x0000003Fu};
constexpr Field<Access::RC_W0, adc1::Jeoc, false, false> adc1_sr_jeoc{0x40012000u, 0x00000004u, 2, 0x00000000u, 0x0000003Fu};
constexpr Field<Access::RC_W0, adc1::Eoc, false, false> adc1_sr_eoc{0x40012000u, 0x00000002u, 1, 0x00000000u, 0x0000003Fu};
constexpr Field<Access::RC_W0, adc1::Awd, false, false> adc1_sr_awd{0x40012000u, 0x00000001u, 0, 0x00000000u, 0x0000003Fu};
constexpr Field<Access::RW, adc1::Ovrie, true> adc1_cr1_ovrie{0x40012004u, 0x04000000u, 26};
constexpr Field<Access::RW, adc1::Res> adc1_cr1_res{0x40012004u, 0x03000000u, 24};
constexpr Field<Access::RW, adc1::Awden, true> adc1_cr1_awden{0x40012004u, 0x00800000u, 23};
constexpr Field<Access::RW, adc1::Jawden, true> adc1_cr1_jawden{0x40012004u, 0x00400000u, 22};
constexpr Field<Access::RW> adc1_cr1_discnum{0x40012004u, 0x0000E000u, 13};
constexpr Field<Access::RW, adc1::Jdiscen, true> adc1_cr1_jdiscen{0x40012004u, 0x00001000u, 12};
constexpr Field<Access::RW, adc1::Discen, true> adc1_cr1_discen{0x40012004u, 0x00000800u, 11};
constexpr Field<Access::RW, adc1::Jauto, true> adc1_cr1_jauto{0x40012004u, 0x00000400u, 10};
constexpr Field<Access::RW, adc1::Awdsgl, true> adc1_cr1_awdsgl{0x40012004u, 0x00000200u, 9};
constexpr Field<Access::RW, adc1::Scan, true> adc1_cr1_scan{0x40012004u, 0x00000100u, 8};
constexpr Field<Access::RW, adc1::Jeocie, true> adc1_cr1_jeocie{0x40012004u, 0x00000080u, 7};
constexpr Field<Access::RW, adc1::Awdie, true> adc1_cr1_awdie{0x40012004u, 0x00000040u, 6};
constexpr Field<Access::RW, adc1::Eocie, true> adc1_cr1_eocie{0x40012004u, 0x00000020u, 5};
constexpr Field<Access::RW> adc1_cr1_awdch{0x40012004u, 0x0000001Fu, 0};
constexpr Field<Access::RW, adc1::Swstart, true> adc1_cr2_swstart{0x40012008u, 0x40000000u, 30};
...
constexpr Field<Access::RW, adc1::Jswstart, true> adc1_cr2_jswstart{0x40012008u, 0x00400000u, 22};
...
constexpr Field<Access::RW, adc1::Align, true> adc1_cr2_align{0x40012008u, 0x00000800u, 11};
constexpr Field<Access::RW, adc1::Eocs, true> adc1_cr2_eocs{0x40012008u, 0x00000400u, 10};
constexpr Field<Access::RW, adc1::Dds, true> adc1_cr2_dds{0x40012008u, 0x00000200u, 9};
constexpr Field<Access::RW, adc1::Dma, true> adc1_cr2_dma{0x40012008u, 0x00000100u, 8};
constexpr Field<Access::RW, adc1::Cont, true> adc1_cr2_cont{0x40012008u, 0x00000002u, 1};
constexpr Field<Access::RW, adc1::Adon, true> adc1_cr2_adon{0x40012008u, 0x00000001u, 0};
constexpr Field<Access::RW, adc1::Smp, false, false> adc1_smpr1_smpx_x{0x4001200Cu, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, adc1::Smp, false, false> adc1_smpr2_smpx_x{0x40012010u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> adc1_jofr1_joffset1{0x40012014u, 0x00000FFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> adc1_jofr2_joffset2{0x40012018u, 0x00000FFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> adc1_jofr3_joffset3{0x4001201Cu, 0x00000FFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> adc1_jofr4_joffset4{0x40012020u, 0x00000FFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> adc1_htr_ht{0x40012024u, 0x00000FFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> adc1_ltr_lt{0x40012028u, 0x00000FFFu, 0};
