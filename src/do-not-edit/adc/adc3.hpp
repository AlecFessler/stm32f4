...
constexpr Field<Access::RC_W0, adc3::Ovr, false, false> adc3_sr_ovr{0x40012200u, 0x00000020u, 5, 0x00000000u, 0x0000003Fu};
constexpr Field<Access::RC_W0, adc3::Strt, false, false> adc3_sr_strt{0x40012200u, 0x00000010u, 4, 0x00000000u, 0x0000003Fu};
constexpr Field<Access::RC_W0, adc3::Jstrt, false, false> adc3_sr_jstrt{0x40012200u, 0x00000008u, 3, 0x00000000u, 0x0000003Fu};
constexpr Field<Access::RC_W0, adc3::Jeoc, false, false> adc3_sr_jeoc{0x40012200u, 0x00000004u, 2, 0x00000000u, 0x0000003Fu};
constexpr Field<Access::RC_W0, adc3::Eoc, false, false> adc3_sr_eoc{0x40012200u, 0x00000002u, 1, 0x00000000u, 0x0000003Fu};
constexpr Field<Access::RC_W0, adc3::Awd, false, false> adc3_sr_awd{0x40012200u, 0x00000001u, 0, 0x00000000u, 0x0000003Fu};
constexpr Field<Access::RW, adc3::Ovrie, true> adc3_cr1_ovrie{0x40012204u, 0x04000000u, 26};
constexpr Field<Access::RW, adc3::Res> adc3_cr1_res{0x40012204u, 0x03000000u, 24};
constexpr Field<Access::RW, adc3::Awden, true> adc3_cr1_awden{0x40012204u, 0x00800000u, 23};
constexpr Field<Access::RW, adc3::Jawden, true> adc3_cr1_jawden{0x40012204u, 0x00400000u, 22};
constexpr Field<Access::RW> adc3_cr1_discnum{0x40012204u, 0x0000E000u, 13};
constexpr Field<Access::RW, adc3::Jdiscen, true> adc3_cr1_jdiscen{0x40012204u, 0x00001000u, 12};
constexpr Field<Access::RW, adc3::Discen, true> adc3_cr1_discen{0x40012204u, 0x00000800u, 11};
constexpr Field<Access::RW, adc3::Jauto, true> adc3_cr1_jauto{0x40012204u, 0x00000400u, 10};
constexpr Field<Access::RW, adc3::Awdsgl, true> adc3_cr1_awdsgl{0x40012204u, 0x00000200u, 9};
constexpr Field<Access::RW, adc3::Scan, true> adc3_cr1_scan{0x40012204u, 0x00000100u, 8};
constexpr Field<Access::RW, adc3::Jeocie, true> adc3_cr1_jeocie{0x40012204u, 0x00000080u, 7};
constexpr Field<Access::RW, adc3::Awdie, true> adc3_cr1_awdie{0x40012204u, 0x00000040u, 6};
constexpr Field<Access::RW, adc3::Eocie, true> adc3_cr1_eocie{0x40012204u, 0x00000020u, 5};
constexpr Field<Access::RW> adc3_cr1_awdch{0x40012204u, 0x0000001Fu, 0};
constexpr Field<Access::RW, adc3::Swstart, true> adc3_cr2_swstart{0x40012208u, 0x40000000u, 30};
...
constexpr Field<Access::RW, adc3::Jswstart, true> adc3_cr2_jswstart{0x40012208u, 0x00400000u, 22};
...
constexpr Field<Access::RW, adc3::Align, true> adc3_cr2_align{0x40012208u, 0x00000800u, 11};
constexpr Field<Access::RW, adc3::Eocs, true> adc3_cr2_eocs{0x40012208u, 0x00000400u, 10};
constexpr Field<Access::RW, adc3::Dds, true> adc3_cr2_dds{0x40012208u, 0x00000200u, 9};
constexpr Field<Access::RW, adc3::Dma, true> adc3_cr2_dma{0x40012208u, 0x00000100u, 8};
constexpr Field<Access::RW, adc3::Cont, true> adc3_cr2_cont{0x40012208u, 0x00000002u, 1};
constexpr Field<Access::RW, adc3::Adon, true> adc3_cr2_adon{0x40012208u, 0x00000001u, 0};
constexpr Field<Access::RW, adc3::Smp, false, false> adc3_smpr1_smpx_x{0x4001220Cu, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, adc3::Smp, false, false> adc3_smpr2_smpx_x{0x40012210u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> adc3_jofr1_joffset1{0x40012214u, 0x00000FFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> adc3_jofr2_joffset2{0x40012218u, 0x00000FFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> adc3_jofr3_joffset3{0x4001221Cu, 0x00000FFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> adc3_jofr4_joffset4{0x40012220u, 0x00000FFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> adc3_htr_ht{0x40012224u, 0x00000FFFu, 0};
constexpr Field<Access::RW, uint32_t, false, false> adc3_ltr_lt{0x40012228u, 0x00000FFFu, 0};
