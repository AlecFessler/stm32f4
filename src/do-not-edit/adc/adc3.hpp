...
constexpr Field<Access::RW, adc3::Ovrie, true, true> adc3_cr1_ovrie{0x40012204u, 0x04000000u, 26};
constexpr Field<Access::RW, adc3::Res> adc3_cr1_res{0x40012204u, 0x03000000u, 24};
constexpr Field<Access::RW, adc3::Awden, true, true> adc3_cr1_awden{0x40012204u, 0x00800000u, 23};
constexpr Field<Access::RW, adc3::Jawden, true, true> adc3_cr1_jawden{0x40012204u, 0x00400000u, 22};
constexpr Field<Access::RW> adc3_cr1_discnum{0x40012204u, 0x0000E000u, 13};
constexpr Field<Access::RW, adc3::Jdiscen, true, true> adc3_cr1_jdiscen{0x40012204u, 0x00001000u, 12};
constexpr Field<Access::RW, adc3::Discen, true, true> adc3_cr1_discen{0x40012204u, 0x00000800u, 11};
constexpr Field<Access::RW, adc3::Jauto, true, true> adc3_cr1_jauto{0x40012204u, 0x00000400u, 10};
constexpr Field<Access::RW, adc3::Awdsgl, true, true> adc3_cr1_awdsgl{0x40012204u, 0x00000200u, 9};
constexpr Field<Access::RW, adc3::Scan, true, true> adc3_cr1_scan{0x40012204u, 0x00000100u, 8};
constexpr Field<Access::RW, adc3::Jeocie, true, true> adc3_cr1_jeocie{0x40012204u, 0x00000080u, 7};
constexpr Field<Access::RW, adc3::Awdie, true, true> adc3_cr1_awdie{0x40012204u, 0x00000040u, 6};
constexpr Field<Access::RW, adc3::Eocie, true, true> adc3_cr1_eocie{0x40012204u, 0x00000020u, 5};
constexpr Field<Access::RW> adc3_cr1_awdch{0x40012204u, 0x0000001Fu, 0};
constexpr Field<Access::RW, adc3::Swstart, true, true> adc3_cr2_swstart{0x40012208u, 0x40000000u, 30};
...
constexpr Field<Access::RW, adc3::Jswstart, true, true> adc3_cr2_jswstart{0x40012208u, 0x00400000u, 22};
...
constexpr Field<Access::RW, adc3::Align, true, true> adc3_cr2_align{0x40012208u, 0x00000800u, 11};
constexpr Field<Access::RW, adc3::Eocs, true, true> adc3_cr2_eocs{0x40012208u, 0x00000400u, 10};
constexpr Field<Access::RW, adc3::Dds, true, true> adc3_cr2_dds{0x40012208u, 0x00000200u, 9};
constexpr Field<Access::RW, adc3::Dma, true, true> adc3_cr2_dma{0x40012208u, 0x00000100u, 8};
constexpr Field<Access::RW, adc3::Cont, true, true> adc3_cr2_cont{0x40012208u, 0x00000002u, 1};
constexpr Field<Access::RW, adc3::Adon, true, true> adc3_cr2_adon{0x40012208u, 0x00000001u, 0};
