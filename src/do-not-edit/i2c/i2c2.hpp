...
constexpr Field<Access::RW, i2c::Smbalert> i2c2_sr1_smbalert{0x40005814u, 0x00008000u, 15};
constexpr Field<Access::RW, i2c::Timeout> i2c2_sr1_timeout{0x40005814u, 0x00004000u, 14};
constexpr Field<Access::RW, i2c::Pecerr> i2c2_sr1_pecerr{0x40005814u, 0x00001000u, 12};
constexpr Field<Access::RW, i2c::Ovr> i2c2_sr1_ovr{0x40005814u, 0x00000800u, 11};
constexpr Field<Access::RW, i2c::Af> i2c2_sr1_af{0x40005814u, 0x00000400u, 10};
constexpr Field<Access::RW, i2c::Arlo> i2c2_sr1_arlo{0x40005814u, 0x00000200u, 9};
constexpr Field<Access::RW, i2c::Berr> i2c2_sr1_berr{0x40005814u, 0x00000100u, 8};
