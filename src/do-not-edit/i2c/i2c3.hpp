...
constexpr Field<Access::RW, i2c::Swrst, true, true> i2c3_cr1_swrst{0x40005C00u, 0x00008000u, 15};
constexpr Field<Access::RW, i2c::Alert, true, true> i2c3_cr1_alert{0x40005C00u, 0x00002000u, 13};
constexpr Field<Access::RW, i2c::Pec, true, true> i2c3_cr1_pec{0x40005C00u, 0x00001000u, 12};
constexpr Field<Access::RW, i2c::Pos, true, true> i2c3_cr1_pos{0x40005C00u, 0x00000800u, 11};
constexpr Field<Access::RW, i2c::Ack, true, true> i2c3_cr1_ack{0x40005C00u, 0x00000400u, 10};
constexpr Field<Access::RW, i2c::Stop, true, true> i2c3_cr1_stop{0x40005C00u, 0x00000200u, 9};
constexpr Field<Access::RW, i2c::Start, true, true> i2c3_cr1_start{0x40005C00u, 0x00000100u, 8};
constexpr Field<Access::RW, i2c::Nostretch, true, true> i2c3_cr1_nostretch{0x40005C00u, 0x00000080u, 7};
constexpr Field<Access::RW, i2c::Engc, true, true> i2c3_cr1_engc{0x40005C00u, 0x00000040u, 6};
constexpr Field<Access::RW, i2c::Enpec, true, true> i2c3_cr1_enpec{0x40005C00u, 0x00000020u, 5};
constexpr Field<Access::RW, i2c::Enarp, true, true> i2c3_cr1_enarp{0x40005C00u, 0x00000010u, 4};
constexpr Field<Access::RW, i2c::Smbtype, true, true> i2c3_cr1_smbtype{0x40005C00u, 0x00000008u, 3};
constexpr Field<Access::RW, i2c::Smbus, true, true> i2c3_cr1_smbus{0x40005C00u, 0x00000002u, 1};
constexpr Field<Access::RW, i2c::Pe, true, true> i2c3_cr1_pe{0x40005C00u, 0x00000001u, 0};
constexpr Field<Access::RW, i2c::Last, true, true> i2c3_cr2_last{0x40005C04u, 0x00001000u, 12};
constexpr Field<Access::RW, i2c::Dmaen, true, true> i2c3_cr2_dmaen{0x40005C04u, 0x00000800u, 11};
constexpr Field<Access::RW, i2c::Itbufen, true, true> i2c3_cr2_itbufen{0x40005C04u, 0x00000400u, 10};
constexpr Field<Access::RW, i2c::Itevten, true, true> i2c3_cr2_itevten{0x40005C04u, 0x00000200u, 9};
constexpr Field<Access::RW, i2c::Iterren, true, true> i2c3_cr2_iterren{0x40005C04u, 0x00000100u, 8};
constexpr Field<Access::RW> i2c3_cr2_freq{0x40005C04u, 0x0000003Fu, 0};
constexpr Field<Access::RW, i2c::Addmode, true, true> i2c3_oar1_addmode{0x40005C08u, 0x00008000u, 15};
...
constexpr Field<Access::RW, uint32_t, true, true> i2c3_oar1_add0{0x40005C08u, 0x00000001u, 0};
constexpr Field<Access::RW, i2c::Endual, true, true> i2c3_oar2_endual{0x40005C0Cu, 0x00000001u, 0};
...
constexpr Field<Access::RW, i2c::F_s, true, true> i2c3_ccr_f_s{0x40005C1Cu, 0x00008000u, 15};
constexpr Field<Access::RW, i2c::Duty, true, true> i2c3_ccr_duty{0x40005C1Cu, 0x00004000u, 14};
...
constexpr Field<Access::RW, i2c::Anoff, true, true> i2c3_fltr_anoff{0x40005C24u, 0x00000010u, 4};
