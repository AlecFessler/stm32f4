...
constexpr Field<Access::RW> ethernet_mac_macfcr_fcb{0x40028018u, 0x00000001u, 0};
constexpr Field<Access::RW> ethernet_mac_macfcr_tfce{0x40028018u, 0x00000002u, 1};
constexpr Field<Access::RW> ethernet_mac_macfcr_rfce{0x40028018u, 0x00000004u, 2};
constexpr Field<Access::RW> ethernet_mac_macfcr_upfd{0x40028018u, 0x00000008u, 3};
constexpr Field<Access::RW> ethernet_mac_macfcr_plt{0x40028018u, 0x00000030u, 4};
constexpr Field<Access::RW> ethernet_mac_macfcr_zqpd{0x40028018u, 0x00000080u, 7};
constexpr Field<Access::RW> ethernet_mac_macfcr_pt{0x40028018u, 0xFFFF0000u, 16};
