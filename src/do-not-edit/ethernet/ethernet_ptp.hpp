...
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_tse{0x40028700u, 0x00000001u, 0};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_tsfcu{0x40028700u, 0x00000002u, 1};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_tsptppsv2e{0x40028700u, 0x00000400u, 10};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_tssptpoefe{0x40028700u, 0x00000800u, 11};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_tssipv6fe{0x40028700u, 0x00001000u, 12};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_tssipv4fe{0x40028700u, 0x00002000u, 13};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_tsseme{0x40028700u, 0x00004000u, 14};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_tssmrme{0x40028700u, 0x00008000u, 15};
constexpr Field<Access::RW> ethernet_ptp_ptptscr_tscnt{0x40028700u, 0x00030000u, 16};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_tspffmae{0x40028700u, 0x00040000u, 18};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_tssti{0x40028700u, 0x00000004u, 2};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_tsstu{0x40028700u, 0x00000008u, 3};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_tsite{0x40028700u, 0x00000010u, 4};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_ttsaru{0x40028700u, 0x00000020u, 5};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_tssarfe{0x40028700u, 0x00000100u, 8};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptscr_tsssr{0x40028700u, 0x00000200u, 9};
constexpr Field<Access::RW, uint32_t, false> ethernet_ptp_ptpssir_stssi{0x40028704u, 0x000000FFu, 0};
...
constexpr Field<Access::RW, uint32_t, false> ethernet_ptp_ptptshur_tsus{0x40028710u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW> ethernet_ptp_ptptslur_tsuss{0x40028714u, 0x7FFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, true, true> ethernet_ptp_ptptslur_tsupns{0x40028714u, 0x80000000u, 31};
constexpr Field<Access::RW, uint32_t, false> ethernet_ptp_ptptsar_tsa{0x40028718u, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> ethernet_ptp_ptptthr_ttsh{0x4002871Cu, 0xFFFFFFFFu, 0};
constexpr Field<Access::RW, uint32_t, false> ethernet_ptp_ptpttlr_ttsl{0x40028720u, 0xFFFFFFFFu, 0};
