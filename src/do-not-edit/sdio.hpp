...
constexpr Field<Access::RW, sdio::Hwfc_en, true, true> sdio_clkcr_hwfc_en{0x40012C04u, 0x00004000u, 14};
constexpr Field<Access::RW, sdio::Negedge, true, true> sdio_clkcr_negedge{0x40012C04u, 0x00002000u, 13};
constexpr Field<Access::RW, sdio::Widbus> sdio_clkcr_widbus{0x40012C04u, 0x00001800u, 11};
constexpr Field<Access::RW, sdio::Bypass, true, true> sdio_clkcr_bypass{0x40012C04u, 0x00000400u, 10};
constexpr Field<Access::RW, sdio::Pwrsav, true, true> sdio_clkcr_pwrsav{0x40012C04u, 0x00000200u, 9};
constexpr Field<Access::RW, sdio::Clken, true, true> sdio_clkcr_clken{0x40012C04u, 0x00000100u, 8};
...
constexpr Field<Access::RW, sdio::Ce_atacmd, true, true> sdio_cmd_ce_atacmd{0x40012C0Cu, 0x00004000u, 14};
constexpr Field<Access::RW, sdio::Nien, true, true> sdio_cmd_nien{0x40012C0Cu, 0x00002000u, 13};
constexpr Field<Access::RW, sdio::Encmdcompl, true, true> sdio_cmd_encmdcompl{0x40012C0Cu, 0x00001000u, 12};
constexpr Field<Access::RW, sdio::Sdiosuspend, true, true> sdio_cmd_sdiosuspend{0x40012C0Cu, 0x00000800u, 11};
constexpr Field<Access::RW, sdio::Cpsmen, true, true> sdio_cmd_cpsmen{0x40012C0Cu, 0x00000400u, 10};
constexpr Field<Access::RW, sdio::Waitpend, true, true> sdio_cmd_waitpend{0x40012C0Cu, 0x00000200u, 9};
constexpr Field<Access::RW, sdio::Waitint, true, true> sdio_cmd_waitint{0x40012C0Cu, 0x00000100u, 8};
...
constexpr Field<Access::RW, sdio::Sdioen, true, true> sdio_dctrl_sdioen{0x40012C2Cu, 0x00000800u, 11};
constexpr Field<Access::RW, sdio::Rwmod, true, true> sdio_dctrl_rwmod{0x40012C2Cu, 0x00000400u, 10};
constexpr Field<Access::RW, sdio::Rwstop, true, true> sdio_dctrl_rwstop{0x40012C2Cu, 0x00000200u, 9};
constexpr Field<Access::RW, sdio::Rwstart, true, true> sdio_dctrl_rwstart{0x40012C2Cu, 0x00000100u, 8};
constexpr Field<Access::RW> sdio_dctrl_dblocksize{0x40012C2Cu, 0x000000F0u, 4};
constexpr Field<Access::RW, sdio::Dmaen, true, true> sdio_dctrl_dmaen{0x40012C2Cu, 0x00000008u, 3};
constexpr Field<Access::RW, sdio::Dtmode, true, true> sdio_dctrl_dtmode{0x40012C2Cu, 0x00000004u, 2};
constexpr Field<Access::RW, sdio::Dtdir, true, true> sdio_dctrl_dtdir{0x40012C2Cu, 0x00000002u, 1};
constexpr Field<Access::RW, sdio::Dten, true, true> sdio_dctrl_dten{0x40012C2Cu, 0x00000001u, 0};
...
constexpr Field<Access::RW, sdio::C, true, true> sdio_icr_ceataendc{0x40012C38u, 0x00800000u, 23};
constexpr Field<Access::RW, sdio::C, true, true> sdio_icr_sdioitc{0x40012C38u, 0x00400000u, 22};
constexpr Field<Access::RW, sdio::C, true, true> sdio_icr_dbckendc{0x40012C38u, 0x00000400u, 10};
constexpr Field<Access::RW, sdio::C, true, true> sdio_icr_stbiterrc{0x40012C38u, 0x00000200u, 9};
constexpr Field<Access::RW, sdio::C, true, true> sdio_icr_dataendc{0x40012C38u, 0x00000100u, 8};
constexpr Field<Access::RW, sdio::C, true, true> sdio_icr_cmdsentc{0x40012C38u, 0x00000080u, 7};
constexpr Field<Access::RW, sdio::C, true, true> sdio_icr_cmdrendc{0x40012C38u, 0x00000040u, 6};
constexpr Field<Access::RW, sdio::C, true, true> sdio_icr_rxoverrc{0x40012C38u, 0x00000020u, 5};
constexpr Field<Access::RW, sdio::C, true, true> sdio_icr_txunderrc{0x40012C38u, 0x00000010u, 4};
constexpr Field<Access::RW, sdio::C, true, true> sdio_icr_dtimeoutc{0x40012C38u, 0x00000008u, 3};
constexpr Field<Access::RW, sdio::C, true, true> sdio_icr_ctimeoutc{0x40012C38u, 0x00000004u, 2};
constexpr Field<Access::RW, sdio::C, true, true> sdio_icr_dcrcfailc{0x40012C38u, 0x00000002u, 1};
constexpr Field<Access::RW, sdio::C, true, true> sdio_icr_ccrcfailc{0x40012C38u, 0x00000001u, 0};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_ceataendie{0x40012C3Cu, 0x00800000u, 23};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_sdioitie{0x40012C3Cu, 0x00400000u, 22};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_rxdavlie{0x40012C3Cu, 0x00200000u, 21};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_txdavlie{0x40012C3Cu, 0x00100000u, 20};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_rxfifoeie{0x40012C3Cu, 0x00080000u, 19};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_txfifoeie{0x40012C3Cu, 0x00040000u, 18};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_rxfifofie{0x40012C3Cu, 0x00020000u, 17};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_txfifofie{0x40012C3Cu, 0x00010000u, 16};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_rxfifohfie{0x40012C3Cu, 0x00008000u, 15};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_txfifoheie{0x40012C3Cu, 0x00004000u, 14};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_rxactie{0x40012C3Cu, 0x00002000u, 13};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_txactie{0x40012C3Cu, 0x00001000u, 12};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_cmdactie{0x40012C3Cu, 0x00000800u, 11};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_dbckendie{0x40012C3Cu, 0x00000400u, 10};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_stbiterrie{0x40012C3Cu, 0x00000200u, 9};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_dataendie{0x40012C3Cu, 0x00000100u, 8};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_cmdsentie{0x40012C3Cu, 0x00000080u, 7};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_cmdrendie{0x40012C3Cu, 0x00000040u, 6};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_rxoverrie{0x40012C3Cu, 0x00000020u, 5};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_txunderrie{0x40012C3Cu, 0x00000010u, 4};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_dtimeoutie{0x40012C3Cu, 0x00000008u, 3};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_ctimeoutie{0x40012C3Cu, 0x00000004u, 2};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_dcrcfailie{0x40012C3Cu, 0x00000002u, 1};
constexpr Field<Access::RW, sdio::Ie, true, true> sdio_mask_ccrcfailie{0x40012C3Cu, 0x00000001u, 0};
