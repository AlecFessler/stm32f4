...
constexpr Field<Access::RW, ltdc::Hspol, true> ltdc_gcr_hspol{0x40016818u, 0x80000000u, 31};
constexpr Field<Access::RW, ltdc::Vspol, true> ltdc_gcr_vspol{0x40016818u, 0x40000000u, 30};
constexpr Field<Access::RW, ltdc::Depol, true> ltdc_gcr_depol{0x40016818u, 0x20000000u, 29};
constexpr Field<Access::RW, ltdc::Pcpol, true> ltdc_gcr_pcpol{0x40016818u, 0x10000000u, 28};
constexpr Field<Access::RW, ltdc::Den, true> ltdc_gcr_den{0x40016818u, 0x00010000u, 16};
...
constexpr Field<Access::RW, ltdc::Ltdcen, true> ltdc_gcr_ltdcen{0x40016818u, 0x00000001u, 0};
constexpr Field<Access::RW, ltdc::Vbr, true> ltdc_srcr_vbr{0x40016824u, 0x00000002u, 1};
constexpr Field<Access::RW, ltdc::Imr, true> ltdc_srcr_imr{0x40016824u, 0x00000001u, 0};
constexpr Field<Access::RW, uint32_t, false, false> ltdc_bccr_bc{0x4001682Cu, 0x00FFFFFFu, 0};
constexpr Field<Access::RW, ltdc::Rrie, true> ltdc_ier_rrie{0x40016834u, 0x00000008u, 3};
constexpr Field<Access::RW, ltdc::Terrie, true> ltdc_ier_terrie{0x40016834u, 0x00000004u, 2};
constexpr Field<Access::RW, ltdc::Fuie, true> ltdc_ier_fuie{0x40016834u, 0x00000002u, 1};
constexpr Field<Access::RW, ltdc::Lie, true> ltdc_ier_lie{0x40016834u, 0x00000001u, 0};
constexpr Field<Access::RO, ltdc::Rrif, true> ltdc_isr_rrif{0x40016838u, 0x00000008u, 3};
constexpr Field<Access::RO, ltdc::Terrif, true> ltdc_isr_terrif{0x40016838u, 0x00000004u, 2};
constexpr Field<Access::RO, ltdc::Fuif, true> ltdc_isr_fuif{0x40016838u, 0x00000002u, 1};
constexpr Field<Access::RO, ltdc::Lif, true> ltdc_isr_lif{0x40016838u, 0x00000001u, 0};
...
constexpr Field<Access::RW, uint32_t, false, false> ltdc_lipcr_lipos{0x40016840u, 0x000007FFu, 0};
...
constexpr Field<Access::RO, ltdc::Hsyncs, true> ltdc_cdsr_hsyncs{0x40016848u, 0x00000008u, 3};
constexpr Field<Access::RO, ltdc::Vsyncs, true> ltdc_cdsr_vsyncs{0x40016848u, 0x00000004u, 2};
constexpr Field<Access::RO, ltdc::Hdes, true> ltdc_cdsr_hdes{0x40016848u, 0x00000002u, 1};
constexpr Field<Access::RO, ltdc::Vdes, true> ltdc_cdsr_vdes{0x40016848u, 0x00000001u, 0};
constexpr Field<Access::RW, ltdc::Cluten, true> ltdc_l1cr_cluten{0x40016884u, 0x00000010u, 4};
constexpr Field<Access::RW, ltdc::Colken, true> ltdc_l1cr_colken{0x40016884u, 0x00000002u, 1};
constexpr Field<Access::RW, ltdc::Len, true> ltdc_l1cr_len{0x40016884u, 0x00000001u, 0};
...
constexpr Field<Access::RW, ltdc::Pf, false, false> ltdc_l1pfcr_pf{0x40016894u, 0x00000007u, 0};
constexpr Field<Access::RW, uint32_t, false, false> ltdc_l1cacr_consta{0x40016898u, 0x000000FFu, 0};
...
constexpr Field<Access::RW, uint32_t, false, false> ltdc_l1cfbar_cfbadd{0x400168ACu, 0xFFFFFFFFu, 0};
...
constexpr Field<Access::RW, uint32_t, false, false> ltdc_l1cfblnr_cfblnbr{0x400168B4u, 0x000007FFu, 0};
...
constexpr Field<Access::RW, ltdc::Cluten, true> ltdc_l2cr_cluten{0x40016904u, 0x00000010u, 4};
constexpr Field<Access::RW, ltdc::Colken, true> ltdc_l2cr_colken{0x40016904u, 0x00000002u, 1};
constexpr Field<Access::RW, ltdc::Len, true> ltdc_l2cr_len{0x40016904u, 0x00000001u, 0};
...
constexpr Field<Access::RW, ltdc::Pf, false, false> ltdc_l2pfcr_pf{0x40016914u, 0x00000007u, 0};
constexpr Field<Access::RW, uint32_t, false, false> ltdc_l2cacr_consta{0x40016918u, 0x000000FFu, 0};
...
constexpr Field<Access::RW, uint32_t, false, false> ltdc_l2cfbar_cfbadd{0x4001692Cu, 0xFFFFFFFFu, 0};
...
constexpr Field<Access::RW, uint32_t, false, false> ltdc_l2cfblnr_cfblnbr{0x40016934u, 0x000007FFu, 0};
